            ...
            <div class="modal-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="uploadFilesTab">
                        @include('BRCommerce::.InsertMedia.InsertMediaTabs.uploadFiles',['id' => $id])
                    </div>

                    <div class="tab-pane" id="singleImageTab">
                        @include('BRCommerce::.InsertMedia.InsertMediaTabs.singleImage',['id' => $id])
                    </div>

                    <div class="tab-pane" id="imageGalleryTab">
                        @include('BRCommerce::.InsertMedia.InsertMediaTabs.gallery',['id' => $id])
                    </div>

                    <div class="tab-pane" id="thumbImageTab">
                        @include('BRCommerce::.InsertMedia.InsertMediaTabs.thumbImage',['id' => $id])
                    </div>
                </div>
            </div>
        </div>
